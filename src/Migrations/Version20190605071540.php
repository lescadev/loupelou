 ...
 */
final class Version20190605071540 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prestataire CHANGE site_internet site_internet VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE siret siret VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
